...
function validarFormulario(e) {
    ...
    if (terminoBusqueda === '') {
        mostrarAlerta('Agreaga algo perro');
        return;
    }
...
function buscarImagenes() {
    ...
    const key = '46335520-539606451f7643a41ff9e2ba9';
...
} // Para hacer una paginación es necesario saber el número total de elementos que se van a mostrar
